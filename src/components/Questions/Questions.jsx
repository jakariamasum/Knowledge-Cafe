        ...
        <div>
            ...
            <div className="overflow-x-auto my-5">
                <table className='table w-full border-collapse bg-sky-300'>
                    ...
                    <tr>
                        <td className='whitespace-normal'>Props makes component reusable</td>
                        <td className='whitespace-normal'>State can not make component reusable</td>
                    </tr>
                    <tr className='hover'>
                        <td className='whitespace-normal'>Props are passed outside a components</td>
                        <td className='whitespace-normal'>State are passed inside a components</td>
                    </tr>
                    <tr>
            ...
            <div className='my-5'>
                ...
                <p>The useState hook is used for storing variables that are part of our application's state and will change as the user interacts with our website.It also use to load the data.
                    <br />
